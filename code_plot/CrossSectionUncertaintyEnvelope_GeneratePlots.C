...
void CrossSectionUncertaintyEnvelope_GeneratePlots(){
    ...
    //number of entries
    const Int_t numEntries = 7;
    size_t xscn_for_scaling = 4;
    
    std::vector<TString> grid_xscn; std::vector<double> grid_axis;
    grid_xscn.emplace_back("minEnvelopeXscn"); grid_axis.emplace_back(0);
    grid_xscn.emplace_back("low3EnvelopeXscn"); grid_axis.emplace_back(1);
    grid_xscn.emplace_back("low1EnvelopeXscn"); grid_axis.emplace_back(2);
    grid_xscn.emplace_back("low2EnvelopeXscn"); grid_axis.emplace_back(3);
    grid_xscn.emplace_back("Bhattacharya2009Xscn"); grid_axis.emplace_back(4);
    grid_xscn.emplace_back("high1EnvelopeXscn"); grid_axis.emplace_back(5);
    grid_xscn.emplace_back("maxEnvelopeXscn"); grid_axis.emplace_back(6);
    
    std::vector<TString> ts_xscn; std::vector<double> spectra_axis;
    ts_xscn.emplace_back("minEnvelopeXscn"); spectra_axis.emplace_back(0);
    ts_xscn.emplace_back("low3EnvelopeXscn"); spectra_axis.emplace_back(1);
    ts_xscn.emplace_back("low1EnvelopeXscn"); spectra_axis.emplace_back(2);
    ts_xscn.emplace_back("low2EnvelopeXscn"); spectra_axis.emplace_back(3);
    ts_xscn.emplace_back("Bhattacharya2009Xscn"); spectra_axis.emplace_back(4);
    ts_xscn.emplace_back("high1EnvelopeXscn"); spectra_axis.emplace_back(5);
    ts_xscn.emplace_back("maxEnvelopeXscn"); spectra_axis.emplace_back(6);
    
    //const char *labels[numEntries] = {"Min", "Low 3", "Low 1", "Low 2", "B2009", "High 1", "Max"};
    const char *labels[numEntries] = {"Min", "Low 1", "Low 2", "Low 3", "B2009", "High 1", "Max"};
    ...
    for(size_t i = 0; i < grid_xscn.size(); ++i){
		...
		for(size_t j = 0; j < ts_xscn.size(); ++j){
            ...
            if(i==xscn_for_scaling && j == xscn_for_scaling) filename_for_scaling = tmp;
    ...
    //hists_absdiff[2]->GetZaxis()->SetRangeUser(minbias_lum, 4);
    gPad->Modified();
    gPad->Update();
